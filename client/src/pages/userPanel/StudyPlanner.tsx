    ...
    try {
      ...
      if (prevHabits) {
        prevHabits.forEach(h => {
          ...
          news.push(supabase.from("study_habits").insert({ ...rest, month: viewMonth, year: viewYear, exam_id: examId, progress: Array(31).fill(false) }));
        });
      }
      ...
      if (prevMastery) {
        prevMastery.forEach(m => {
          ...
          news.push(supabase.from("user_mastery").insert({ ...rest, month: viewMonth, year: viewYear, exam_id: examId, progress: Array(31).fill(false) }));
        });
      }
      ...
      <main className="max-w-400 mx-auto p-4 md:p-8 space-y-10 pb-20">
        <div className="grid sm:grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="flex flex-col md:flex-row gap-8">
              <div className="flex-1">
                <TrackerGrid
                  ...
                  isPastMonth={viewYear < currentYear || (viewYear === currentYear && viewMonth < currentMonth)}
          ...
          <section className=" lg:col-span-8">
            <DailyRoutine habits={habits} onRefresh={fetchData} />
          </section>
        </div>
      </main>
    </div>
