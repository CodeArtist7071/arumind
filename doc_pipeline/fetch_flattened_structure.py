...
def main():
    ...
    for c in chapters:
        ...
        if sid:
            ...
            chapters_by_subject[sid].append(c.get("name"))
    ...
    for es in exam_subjects:
        ...
        if eid and sid:
            ...
            if subj:
                subjects_by_exam[eid][subj.get("name")] = chapters_by_subject.get(sid, [])
    ...
    for e in exams:
        ...
        if bid:
            ...
            exams_by_board[bid][e.get("name")] = subjects_by_exam.get(e["id"], {})
            
    # Assemble final JSON hierarchy globally
    output_hierarchy = {}
    for b in boards:
        output_hierarchy[b.get("name")] = exams_by_board.get(b["id"], {})
        
    output_file = "structure_flat.json"
